...
{
    /// <inheritdoc />
    public partial class ChangeAuthTableLogic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PermissionAssignments_Roles_FromRoleId",
                        column: x => x.FromRoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PermissionAssignments_Roles_ToRoleId",
                        column: x => x.ToRoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PermissionAssignments_Users_AssignedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionAssignments_AssignedByUserId",
                table: "PermissionAssignments",
                column: "AssignedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PermissionAssignments_FromRoleId_ToRoleId_PermissionId",
                table: "PermissionAssignments",
                columns: new[] { "FromRoleId", "ToRoleId", "PermissionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionAssignments_ToRoleId",
                table: "PermissionAssignments",
                column: "ToRoleId");
